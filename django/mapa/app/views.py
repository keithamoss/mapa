...
class MapsViewSet(viewsets.ModelViewSet):
    ...
    # def favourite_symbol(self, request, pk=None, format=None):
    #     """
    #     Favourite a symbol from a schema on this map.
    #     """
    #     map = self.get_object()
    #     if map.owner_id.id != request.user.id:
    #         return Response({}, status.HTTP_401_UNAUTHORIZED)
    ...
    #     if isinstance(schemaId, int) and isinstance(symbolId, int):
    #         existingFavourites = [i for i in map.favourited_symbols if i["schema_id"] == schemaId]
    #         if len(existingFavourites) > 0:
    #             favourited_symbols = []
    #             for item in map.favourited_symbols:
    #                 if item["schema_id"] == schemaId:
    #                     favourited_symbols.append({
    #                         "schema_id": schemaId,
    #                         "symbol_ids": list(set([*item["symbol_ids"], symbolId]))
    #                     })
    #                 else:
    #                     favourited_symbols.append(item)
    #         else:
    #             favourited_symbols = map.favourited_symbols
    #             favourited_symbols.append({
    #                 "schema_id": schemaId,
    #                 "symbol_ids": [symbolId]
    #             })

    #         serializer = MapSerializer(map, {"favourited_symbols": favourited_symbols}, partial=True)
    #         if serializer.is_valid() is True:
    #             serializer.save()
    #             return Response({}, status=status.HTTP_200_OK)

    # @action(detail=True, methods=["POST"], permission_classes=(IsAuthenticated,))
    # def unfavourite_symbol(self, request, pk=None, format=None):
    #     """
    #     Unfavourite a symbol from a schema on this map.
    #     """
    #     map = self.get_object()
    #     if map.owner_id.id != request.user.id:
    #         return Response({}, status.HTTP_401_UNAUTHORIZED)
    ...
    #                     favourited_symbols.append({
    #                         "schema_id": schemaId,
    #                         "symbol_ids": [i for i in item["symbol_ids"] if i != symbolId]
    #                     })
    #                 else:
    #                     favourited_symbols.append(item)
