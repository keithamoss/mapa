...
export const getFilteredFeatureIds = (state: RootState) =>
  state.app.filteredFeatures;

export const getCountOfFilteredFeatureIds = (state: RootState) =>
  state.app.filteredFeatures.length;
