...
const initialState: AppState = {
	...
	mapView: undefined,
	selectedFeatures: [],
	search: defaultSearchParameters,
	filteredFeatures: [],
	value: 0,
	status: 'idle',
};
...
export const { setActiveMapId, setMapView, setSelectedFeatures, setSearchParameters, setFilteredFeatures } =
	appSlice.actions;
...
export const getSelectedFeatureIds = (state: RootState) => state.app.selectedFeatures;

export const getSearchParameters = (state: RootState) => state.app.search;

export const getFilteredFeatureIds = (state: RootState) => state.app.filteredFeatures;
