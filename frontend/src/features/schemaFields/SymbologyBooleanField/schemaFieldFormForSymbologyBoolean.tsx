          ...
          <form onSubmit={stopPropagate(handleSubmit(onDoneWithForm))}>
            ...
            >
              <FormGroup>
                ...
                <FormHelperText>
                  Will be used if you don't enter anything when creating a
                  feature
                </FormHelperText>
              </FormGroup>
            ...
            >
              ...
              <FormGroup>
                <Typography variant="body2">
                  This will be overwritten by any symbology set by fields that
                  come after this one.
                </Typography>
                ...
                {symbol !== undefined && isEmpty(symbol) === false && (
                  <Typography variant="caption">
                    Symbology has been set
                  </Typography>
                )}

                {(symbol === undefined || isEmpty(symbol) === true) && (
                  <Typography variant="caption">
                    Symbology has not been set
                  </Typography>
                )}
              </FormGroup>
              ...
              {errors.symbol && (
                <FormHelperText error>
                  Symbol errors: {errors.symbol.message}
                </FormHelperText>
              )}
            </FormControl>
          </form>
