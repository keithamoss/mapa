...
import { FeatureDataItem, FeatureDataItemNumberField } from '../../../app/services/features';
...
function SchemaDataEntryNumberField(props: Props) {
	...
	return (
		<TextField
			...
			helperText={schemaField.default_value !== undefined ? `Default value: ${schemaField.default_value}` : undefined}
