...
function SchemaFieldFormForNumberField(props: Props) {
	...
	const {
		...
		defaultValues: {
			...
			default_value: getNumberOrZeroForSchemasFieldsFormField(field, 'default_value'),
		},
	});

	const onDoneWithForm: SubmitHandler<FeatureSchemaFieldDefinitionNumberFieldFormModifiableProps> = (data) => {
