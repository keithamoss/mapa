				...
				>
					...
					<Box sx={{ width: '100%' }}>
						<Grid container spacing={1}>
							{getAvailableStylesForIcon(selectedIcon).map((familyStyle, index) => (
								<Grid
								...
								>
									...
									>
										...
										>
											{getFontAwesomeIconFromLibraryAsSVGImage(selectedIcon, familyStyle.family, familyStyle.style)}
										</Box>

										<Typography variant="subtitle2" sx={{ textAlign: 'center' }}>
											{getIconFamilyAndStyleName(familyStyle.family, familyStyle.style)}
										</Typography>
									</Paper>
								</Grid>
							))}
