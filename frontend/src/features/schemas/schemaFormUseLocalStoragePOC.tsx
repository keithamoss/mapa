...
// 	const [formValuesLocalStorage, setFormValues] = useLocalStorage('formValues', {});
// 	console.log('🚀 ~ file: schemaForm.tsx:111 ~ SchemaForm ~ formValues:', formValuesLocalStorage);
...
// 	// Object.entries(formValuesLocalStorage).forEach(([fieldName, fieldValue]) => {
// 	// 	console.log('🚀 ~ file: schemaForm.tsx:115 ~ Object.entries ~ fieldName:', fieldName, fieldValue);
// 	// 	if (JSON.stringify(currentFormValues[fieldName as any]) !== JSON.stringify(fieldValue)) {
// 	// 		console.log('foobar', currentFormValues[fieldName as any], fieldValue);
// 	// 		setValue(fieldName as any, fieldName, { shouldDirty: true });
// 	// 	}
// 	// });
...
// 	const prevFormValues = usePrevious(formValuesLocalStorage);
// 	// console.log('🚀 ~ file: schemaForm.tsx:113 ~ SchemaForm ~ prevFormValues:', prevFormValues);

// 	// if (JSON.stringify(currentFormValues) !== JSON.stringify(prevFormValues)) {
...
// 			setFormValues(currentFormValues);
// 		}
// 	}, [currentFormValues, prevFormValues, setFormValues]);

// 	// window.addEventListener('popstate', (e) => {
// 	// 	// URL changed!
// 	// 	console.log('addEventListener');

// 	// 	// setDarkTheme((prevValue: boolean) => getValues());
...
// 	// 	// navigate('/SchemaManager/Create', { replace: true }); // redirect!!!
// 	// });
