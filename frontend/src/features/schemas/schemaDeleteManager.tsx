...
function SchemaDeleteManager(props: Props) {
  ...
  const [
    deleteSchema,
    { isSuccess: isDeleteSchemaSuccessful, error: deleteError },
  ] = useDeleteSchemaMutation();
        ...
        <Paper elevation={0} sx={{ m: 3 }}>
          {deleteError !== undefined && (
            <Alert severity="error" sx={{ mb: 3 }}>
              ...
              Something went wrong when we tried to delete this schema. It
              loooks like it may still be in use somehow.
            </Alert>
          )}
          ...
          {canDeleteCheck.deletable === true && (
            <React.Fragment>
              <Alert severity="info">
                ...
                This schema is not used by any features, so you're safe to
                delete it.
              </Alert>
          ...
          {canDeleteCheck.deletable === false && (
            <React.Fragment>
              <Alert severity="warning">
                ...
                To delete this schema, please remove it from the features on
                these maps first.
              </Alert>
