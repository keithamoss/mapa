  ...
  return (
    <StyledDiv>
      <Alert severity="info">
        ...
        <br />
        <p>
          <MapIcon color="primary" /> <strong>Maps</strong> that let you do some
          cool stuff like this and that.
        </p>
        <p>
          <Schema color="primary" /> <strong>Schemas</strong> that let you do
          other cool stuff like this and that.
        </p>
        <p>
          <AddLocationAlt /> <strong>Features</strong> that let you do even
          cooler stuff like this and that.
        </p>
